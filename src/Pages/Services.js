...
function Services() {
  ...
  return (
    <div className="overflow-hidden">
      <Helmet>
        <title>Our Services - Edu Tech</title>
        <meta
          name="description"
          content="Discover the range of services we offer at Edu Tech, including HR solutions, recruitment consulting, and workforce planning."
        />
        <meta name="keywords" content="HR solutions, recruitment consulting, workforce planning, Edu Tech" />
      </Helmet>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between lg:gap-2">
          <div
            ...
            <p className="text-white mb-10 lg:mb-0 text-center lg: lg:text-start font-[poppins] text-sm lg:text-base lg:w-[750px] lg:ps-10 p-2">
              Welcome to our Edu , where expertise meets opportunity!
      ...
      className="px-4 flex flex-col items-center">
        <h1 className="text-center font-bold text-lg md:text-2xl mt-12 lg:text-3xl">
          Developing Your Career With Edu!
        </h1>
