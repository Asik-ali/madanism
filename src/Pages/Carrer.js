...
function Carrer() {
  ...
  return (
    <div>
       <Helmet>
        <title>Careers - Edu Tech</title>
        <meta
          name="description"
          content="Join our team at Edu Tech! Explore open positions and become part of an innovative company."
        />
        <meta name="keywords" content="Careers, job openings, Edu Tech, frontend developer, backend developer, UI/UX designer" />
        <meta name="author" content="Edu Tech Team" />
        <meta property="og:title" content="Careers - Edu Tech" />
        <meta
          property="og:description"
          content="Explore career opportunities at Edu Tech and join a growing team working on cutting-edge education technology."
        />
        <meta property="og:image" content="https://example.com/careers-image.jpg" />
        <meta property="og:url" content="https://epicad.vercel.app/careers" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Careers - Edu Tech" />
        <meta
          name="twitter:description"
          content="Explore career opportunities at Edu Tech and join a growing team working on cutting-edge education technology."
        />
        <meta name="twitter:image" content="https://example.com/careers-image.jpg" />
      </Helmet>
      ...
      className="bg-gray-100 mb-10 mt-10 p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 mt-4">
          To apply, send your resume and a cover letter to <a href="mailto:email@example.com"
            className="text-blue-500">edu@gmail.com</a>.
        </p>
      </div>
    </div>
  )
