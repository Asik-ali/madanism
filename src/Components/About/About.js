...
function AboutContent() {
  ...
  return (
    <>
    <Helmet>
        <title>About Us - Edu Tech</title>
        <meta name="description" content="Learn more about Edu Tech, a platform offering advanced educational tools and technology to support students and educators." />
        <meta name="keywords" content="Edu Tech, About, education, technology, tools for education" />
        <meta name="author" content="Edu Tech Team" />

        {/* <!-- Open Graph Meta Tags --> */}
        <meta property="og:title" content="About Us - Edu Tech" />
        <meta property="og:description" content="Edu Tech provides innovative educational tools and resources for students and teachers to enhance their learning experience." />
        <meta property="og:image" content="https://images.pexels.com/photos/21696/pexels-photo.jpg" />
        <meta property="og:url" content="https://epicad.vercel.app/about" />
        <meta property="og:type" content="website" />

        {/* <!-- Twitter Card Meta Tags --> */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Us - Edu Tech" />
        <meta name="twitter:description" content="Edu Tech offers cutting-edge educational tools to improve teaching and learning experiences." />
        <meta name="twitter:image" content="https://images.pexels.com/photos/21696/pexels-photo.jpg" />
      </Helmet>
    <div 
      ...
      className="bg-gradient-to-b from-blue-500 to-black  ">
        <div className="flex flex-col-reverse lg:flex-row justify-between">
          <div className=" justify-center  lg:ps-10 flex flex-col gap-6">
            ...
            Edu Tech provides you with Human Resource Solutions that are
          ...
          <div className="flex ms-10 gap-10 mt-10">
            ...
            <div>
              <p className="lg:w-[300px] text-gray-700 text-lg font-[raleway] ">
                At Edu Tech, we advocate for a personalized approach to HR
...
<div className="container  mx-auto mt-8">
    ...
    <div className="container mx-auto mt-8 overflow-hidden pb-8">
      <h1
      data-aos="flip-up"
      className="text-3xl font-bold mb-6 text-center">Our Approach at Edu Tech</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
