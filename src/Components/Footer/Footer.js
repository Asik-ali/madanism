  ...
  return (
    ...
    data-aos-easing="ease-in-sine" className="bg-[#8D99AE] ">
            ...
            <div>
              <div>
                <h5 className="text-2xl">
                  Edu <span className="text-[#1369AA]">Tech</span>
                </h5>
              </div>

              <p className="mt-4 max-w-xs text-gray-500">
                Edu Tech wide end to end Human Resource managment to
              ...
              <ul className="mt-8 flex gap-6">
                <li>
                  <a
                    href="https://www.facebook.com/EduTech"
                    rel="noreferrer"
                    target="_blank"
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  <li className="flex  gap-2">
                    ...
                    <span className="w-[200px]">
                      -4, Cmp Cross Lane, Pettai, Anna nagar East,
                      Chennai 600005
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <BsTelephoneFill /> 7896544569/7535469856
                  </li>
                  <li className="flex items-center gap-2">
                    <GrMail className="text-xl" />{" "}
                    <span className="w-4">edu@gmail.com</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <p className="text-lg text-center p-3 bg-black w-full text-white">
          &copy; 2024. Edu Tech. All rights reserved.
        </p>
      </footer>
    </div>
  );
