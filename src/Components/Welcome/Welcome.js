  ...
  return (
    ...
    data-aos-easing="ease-in-sine"
     className='mt-10 overflow-x-hidden mb-10'>
        <h1 className='text-center text-3xl lg:text-4xl font-[poppins] px-4'>Welcome To Edu <span className='text-[#1369AA]'>Tech</span></h1>
       <div className='flex flex-col lg:flex-row lg:mx-4 container px-4 items-center justify-center gap-10  mt-5'>
        ...
        <div className='flex flex-col'>
            ...
            <div className='lg:w-[600px] mt-7 flex flex-col gap-2 leading-7'>
                <p>Edu Tech provides  you with Human Resource Solutions that are well researched.Our team is trained to deliver relevant profiles within tight deadlines.</p>
