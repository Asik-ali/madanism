...
function Contactus() {
  ...
  return (
    <div>
       <Helmet>
        <title>Contact Us - Edu Tech</title>
        <meta
          name="description"
          content="Get in touch with Edu Tech! Reach out for support, inquiries, or partnership opportunities."
        />
        <meta name="keywords" content="contact, support, inquiries, Edu Tech" />
      </Helmet>
      <div
      data-aos="fade-right"
      data-aos-offset="300"
