...
function Clientpage() {
  ...
  return (
    <div>
      <Helmet>
        <title>Our Clients - Edu Tech</title>
        <meta
          name="description"
          content="Discover the trusted clients we partner with to drive success in the education technology space."
        />
        <meta name="keywords" content="Edu Tech, clients, partnerships, technology, education" />
        <meta name="author" content="Edu Tech Team" />
        <meta property="og:title" content="Our Clients - Edu Tech" />
        <meta
          property="og:description"
          content="Edu Tech works with leading clients to enhance educational experiences through technology."
        />
        <meta property="og:image" content="https://example.com/clients-image.jpg" />
        <meta property="og:url" content="https://example.com/clients" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Our Clients - Edu Tech" />
        <meta
          name="twitter:description"
          content="Edu Tech works with leading clients to enhance educational experiences through technology."
        />
        <meta name="twitter:image" content="https://example.com/clients-image.jpg" />
      </Helmet>
